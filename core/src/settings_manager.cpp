...
SettingsManager::SettingsManager(QObject *parent) : QObject(parent) {
    m_settings = {{"pluginEnableLADSPA", true},
                  ...
                  {"pluginPathsDSSI", QStringList({"/usr/lib/dssi", "/usr/local/lib/dssi"})},
                  {"pluginEnableLV2", true},
                  {"pluginPathsLV2", QStringList({"/usr/lib/lv2", "/usr/local/lib/lv2"})},
                  {"pluginEnableVST2", true},
                  {"pluginPathsVST2", QStringList({"/usr/lib/vst", "/usr/lib/vst2", "/usr/local/lib/vst", "/usr/local/lib/vst2"})},
                  {"pluginEnableVST3", true},
                  {"pluginPathsVST3", QStringList({"/usr/lib/vst3", "/usr/local/lib/vst3"})},
                  {"pluginEnableCLAP", true},
                  {"pluginPathsCLAP", QStringList({"/usr/lib/clap", "/usr/local/lib/clap"})},
                  {"pluginEnableSF2", true},
                  {"pluginPathsSF2", QStringList({"/usr/share/soundfonts", "/usr/share/sounds/sf2"})},
                  {"pluginEnableSFZ", true},
                  {"pluginPathsSFZ", QStringList({"/usr/share/sounds/sfz"})},
                  ...
                  {"carlaResourceDir", "/usr/share/carla/resources"},
                  {"carlaDiscoverySearchPaths",
                   QStringList({"/usr/lib/carla/carla-discovery-native", "/usr/local/lib/carla/carla-discovery-native", "/usr/lib64/carla/carla-discovery-native", "/usr/bin/carla-discovery-native", "/usr/local/bin/carla-discovery-native"})},
                  {"sceneWidthMax", 8000},
                  {"sceneHeightMax", 8000},
                  {"sceneFramesMin", 100},
